...
public class part2 {
	...
	public static void main(String[] args) {
		...
		// (1) Perform permutation of (1, 3), (1, 5), (10, 3000), (5000, 10000), and (6,
		// 15000).
		...
		boolean t = test_permute(row1, row3_p) && test_permute(row3, row5_p) && test_permute(row3, row5_p)
				&& test_permute(row6, row15000_p) && test_permute(row10, row3000_p)
				&& test_permute(row5000, row10000_p);
		System.out.println(t);

		// (2) Perform 3.0*row[2] + row[4], permute (2, 5), and then perform -3.0*row[5]
		// + row[4].
		...
		// (3)Perform Ax = b, where x is a column vector with all its elements equal to
		// 1.0.
		// You can readily see that the signed sum of the elements in b is the signed
		...
		// (4) Compute first norm, which should be smaller than a set tolerance (say
		// 10-7).
