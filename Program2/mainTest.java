...
public class mainTest {
	...
	public static void main(String[] args) {
		...
		System.out.println("Comments:With the chage of vector b, the normalized residual norm "
				+ "is getting larger, but all three values are close to each other.");
		System.out.println("Iterative solver's edge is that it can change the convergence condition");
	}
