...
%plot of task3 
%plots of ID vs. VDS with the 10 values of VGS for IDmodel (normalized).
...
for i = 1:len
    ...
    Id(i) = cal_Id(Is, k, Vgb, Vth, Vt, Vsb, Vdb) / Ids;
end
...
for i = 1:10
    ...
    xlabel('Vds(V)')
    ylabel('Model Id(A) (Normalized)')
    title("Task3: Vds vs. Model Id (Normalized) for given Vgs")
    hold on;
